...
/**
 * ConnectionAccountLinks Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ConnectionAccountLinks implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ConnectionAccountLinks';
    ...
    */
     ...
     * Sets transactions
     *
     * @param string $transactions transactions link to the transactions associated with this account
     *
     * @return self
     */
     ...
     * Sets self
     *
     * @param string $self self link to the requested account
     *
     * @return self
     */
